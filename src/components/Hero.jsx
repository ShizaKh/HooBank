...
/* ss:text stroke
ss:leading changes height bw words(like line height)*/

const Hero = () => (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>

                  {/* left side of hero section starts here */}
      ...
      <div className={` flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        {/* img is given relative position so gradients can be handled */}
      ...
      {/* in small devices, get started btn will be visible after robot img */}
